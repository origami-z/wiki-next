...
export default async function EventsPage({ params }: EventsPageProps) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8">Game Events</h1>
        ...
        <div className="lg:col-span-2 space-y-12">
          ...
          <section>
            ...
            {activeEvents.length > 0 ? (
              ...
              <p className="text-gray-500 italic">No active events currently.</p>
            )}
          </section>

          {/* Upcoming Events */}
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-blue-600 dark:text-blue-400">Upcoming Events</h2>
